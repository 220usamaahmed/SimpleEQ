    ...
    bool shouldDrawButtonAsDown)
{
    ...
    if (auto* pb = dynamic_cast<PowerButton*>(&toggleButton))
    {
        ...
        auto colour = toggleButton.getToggleState() ? Colours::dimgrey : Colour(9u, 172u, 1u);
        g.setColour(colour);
    ...
    {
        auto colour = toggleButton.getToggleState() ? Colour(9u, 172u, 1u) : Colours::dimgrey;
...
void RotarySliderWithLabels::paint(juce::Graphics& g)
{
    ...
    getLookAndFeel().drawRotarySlider(g, sliderBounds.getX(),
        sliderBounds.getY(), sliderBounds.getWidth(), sliderBounds.getHeight(),
...
void ResponseCurveComponent::parameterValueChanged(int paramterIndex, float newValue)
{
    ...
    analyzerEnabledButtonAttachment(audioProcessor.apvts, "Analyzer Enabled", analyzerEnabledButton)
{
    ...
    lowCutSlopeSlider.labels.add({ 1.f, "42" });

    highCutSlopeSlider.labels.add({ 0.f, "12" });
    highCutSlopeSlider.labels.add({ 1.f, "42" });
